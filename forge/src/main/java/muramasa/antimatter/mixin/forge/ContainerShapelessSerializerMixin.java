...
import muramasa.antimatter.recipe.container.ContainerItemShapelessRecipe.Serializer;
...
public class ContainerShapelessSerializerMixin implements IForgeRegistryEntry<Serializer> {
    @Unique
