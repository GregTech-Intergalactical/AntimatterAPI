...
public class AntimatterStoneTypes {
    ...
    public static StoneType BASALT = AntimatterAPI.register(StoneType.class, new StoneType(Ref.ID, "basalt", AntimatterMaterials.Basalt, new Texture("minecraft", "block/basalt_side"), SoundType.BASALT, false).setState(Blocks.BASALT).setHardnessAndResistance(1.25F, 4.2F)
