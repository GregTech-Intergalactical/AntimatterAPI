...
public class AntimatterMaterials {
    ...
    public static Material Blaze = AntimatterAPI.register(Material.class, new Material(Ref.ID, "blaze", 0xffc800, NONE)).setMassMultiplierAndDivider(3,2);
    ...
    public static Material Coal = AntimatterAPI.register(Material.class, new Material(Ref.ID, "coal", 0x464646, LIGNITE)).setMassMultiplierAndDivider(2, 1);
    public static Material Diamond = AntimatterAPI.register(Material.class, new Material(Ref.ID, "diamond", /*0x3de0e5*/0xc8ffff, DIAMOND)).setMassMultiplierAndDivider(64, 1);
    ...
    public static Material EnderEye = AntimatterAPI.register(Material.class, new Material(Ref.ID, "endereye", 0xa0fae6, SHINY)).setMassMultiplierAndDivider(2, 1);
