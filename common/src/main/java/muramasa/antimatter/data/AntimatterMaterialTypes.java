...
public class AntimatterMaterialTypes {
    ...
    public static MaterialTypeItem<?> GEM_EXQUISITE = new MaterialTypeItem<>("gem_polished", 2, true, Ref.U);
    public static MaterialTypeItem<?> GEM_FLAWLESS = new MaterialTypeItem<>("gem_polished", 2, true, Ref.U);
    public static MaterialTypeItem<?> GEM_FLAWED = new MaterialTypeItem<>("gem_polished", 2, true, Ref.U);
    public static MaterialTypeItem<?> GEM_CHIPPED = new MaterialTypeItem<>("gem_polished", 2, true, Ref.U);
