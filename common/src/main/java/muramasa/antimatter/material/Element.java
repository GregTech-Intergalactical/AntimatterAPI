...
public class Element implements IAntimatterObject {
    ...
    public static Element T = new Element(1, 2, 0,1,90, "tritium",  "T", 378432000,null,null,"He3",true);
    public static Element He3 = new Element(2, 1, 0,1,179,"helium_3", "He3", -1,null,null,null,true);
    public static Element Tl209 = new Element(81, 128, 0, 120,11850,"thallium_209", "Tl209",120,null,null, "Pb",  true);
    public static Element Tl210 = new Element(81, 129, 0, 120,11850,"thallium_210", "Tl210",120,null,null, "Pb",  true);
    public static Element Bi213 = new Element(83, 130, 0, 225,9780,"bismuth_213", "Bi213",165600,"Tl209",null, "Po213",  true);
    public static Element Bi214 = new Element(83, 131, 0, 225,9780,"bismuth_214", "Bi214",1200,"Tl210",null, "Po214",  true);
    public static Element Po213 = new Element(84, 129, 0, 1,9196,"polonium_213", "Po213",1,"Pb",null, null,  true);
    public static Element Po214 = new Element(84, 130, 0, 1,9196,"polonium_214", "Po214",1,"Pb",null, null,  true);
    public static Element Po215 = new Element(84, 131, 0, 1,9196,"polonium_215", "Po215",1,"Pb",null, null,  true);
    public static Element Po216 = new Element(84, 132, 0, 1,9196,"polonium_216", "Po216",1,"Pb",null, null,  true);
    public static Element Po218 = new Element(84, 134, 0, 1,9196,"polonium_218", "Po218",180,"Pb",null, "At218",  true);
    public static Element At217 = new Element(85, 132, 0, 1,1,"astatine_217", "At217",1,"Bi213",null, null,  true);
    public static Element At218 = new Element(85, 133, 0, 1,1,"astatine_218", "At218",2,"Bi214",null, null,  true);
    public static Element Rn219 = new Element(86, 133, 0, 1,9730,"radon_219", "Rn219",4,"Po215",null, null,  true);
    public static Element Rn220 = new Element(86, 134, 0, 1,9730,"radon_220", "Rn220",56,"Po216",null, null,  true);
    public static Element Rn222 = new Element(86, 136, 0,1,9730,"radon_222", "Rn222",345600,"Po218",null,null,  true);
    public static Element Fr221 = new Element(87, 134, 0, 1,1,"francium_221", "Fr221",300,"At217",null,null,  true);
    public static Element Fr223 = new Element(87, 136, 0, 1,1,"francium_223", "Fr223",1320,null,null,"Ra223",  true);
    public static Element Ra223 = new Element(88, 139, 0,1,5500,"radium_223", "Ra223",950400,"Rn219",null,null,  true);
    public static Element Ra224 = new Element(88, 140, 0,1,5500,"radium_224", "Ra224",345600,"Rn220",null,null,  true);
    public static Element Ra225 = new Element(88, 141, 0,1,5500,"radium_225", "Ra225",1296000,null,null,"Ac225",  true);
    public static Element Ra226 = new Element(88, 142, 0,1,5500,"radium_226", "Ra226",50520672000L,"Ra222",null,null,true);
    public static Element Ra228 = new Element(88, 143, 0,1,5500,"radium_228", "Ra228",189216000,null,null,"Ac228",  true);
    public static Element Ac225 = new Element(89, 136, 0, 1,1,"actinium_225", "Ac225",864000,"Fr221",null,null,  true);
    public static Element Ac227 = new Element(89, 138, 0, 1,1,"actinium_227", "Ac227",693792000,"Fr223",null,"Th227",  true);
    public static Element Ac228 = new Element(89, 139, 0, 1,1,"actinium_228", "Ac228",21600,null,null,"Th228",  true);
    public static Element Th227 = new Element(90, 137, 0,230,11724,"thorium_227", "Th227",1641600,"Ra223",null,null,  true);
    public static Element Th228 = new Element(90, 138, 0,230,11724,"thorium_228", "Th228",63072000,"Ra224",null,null,  true);
    public static Element Th229 = new Element(90, 139, 0,230,11724,"thorium_229", "Th229",10402938000L,"Ra225",null,null,  true);
    public static Element Th230 = new Element(90, 140, 0,230,11724,"thorium_230", "Th230",2365200000L,"Ra226",null,null,  true);
    public static Element Th231 = new Element(90, 141, 0,230,11724,"thorium_231", "Th231",93600,"Ra228",null,"Pa231",  true);
    public static Element Th233 = new Element(90, 143, 0,230,11724,"thorium_233", "Th233",1320,null,null,"Pa233",true);
    public static Element Th234 = new Element(90, 144, 0,230,11724,"thorium_234", "Th234",2073600, null,null,"Pa234",true);
    public static Element Pa231 = new Element(91, 140, 0,1,15370,"protactinium_231", "Pa231",1040688000, "Ac227",null,null,true);
    public static Element Pa232 = new Element(91, 141, 0,1,15370,"protactinium_232", "Pa232",86400,null,null, "U232",  true);
    public static Element Pa233 = new Element(91, 142, 0,1,15370,"protactinium_233", "Pa233",2332800, null,null,"U233",true);
    public static Element Pa234 = new Element(91, 143, 0,1,15370,"protactinium_234", "Pa234",25200, null,null,"U234",true);
    public static Element U232 = new Element(92, 140, 0,275,19160,"uranium_232", "U232",2175984000L, "Th228",null,null,true);
    public static Element U233 = new Element(92, 141, 0,275,19160,"uranium_233", "U233",6307200000000L, "Th229",null,null,true);
    public static Element U234 = new Element(92, 142, 0,275,19160,"uranium_234", "U234",6307200000000L, "Th230",null,null,true);
    public static Element U235 = new Element(92, 143, 0,275,19160,"uranium_235", "U235",22075200000000000L, "Th231",null,null,true);
    public static Element U237 = new Element(92, 145, 0,275,19160,"uranium_237", "U237",604800, null,null,"Np237",true);
    public static Element U238 = new Element(92, 146, 0,275,19160,"uranium_238", "U238",126144000000000000L, "Th234",null,null,true);
    public static Element U239 = new Element(92, 147, 0,275,19160,"uranium_239", "U239",1380,null,null,"Np239",true);
    public static Element U240 = new Element(92, 148, 0,275,19160,"uranium_240", "U240",50400,null,null,"Np240",true);
    public static Element Np236 = new Element(93, 143, 0,1,20450,"neptunium_236", "Np236",6307200000000L, "Pa232",null,"Pu236",true);
    public static Element Np237 = new Element(93, 144, 0,1,20450,"neptunium_237", "Np237",63072000000000L,"Pa233", null,null,true);
    public static Element Np238 = new Element(93, 145, 0,1,20450,"neptunium_238", "Np238",172800, null,null,"Pu238",true);
    public static Element Np239 = new Element(93, 146, 0,1,20450,"neptunium_239", "Np239",172800,null,null,"Pu239",true);
    public static Element Np240 = new Element(93, 147, 0,1,20450,"neptunium_240", "Np240",3720,null,null,"Pu240",true);
    public static Element Pu236 = new Element(94, 142, 0, 1,19816,"plutonium_236", "Pu236",94608000,"U232",null,null,true);
    public static Element Pu238 = new Element(94, 144, 0, 1,19816,"plutonium_238", "Pu238",2775168000L,"U234",null,null,true);
    public static Element Pu239 = new Element(94, 145, 0, 1,19816,"plutonium_239", "Pu239",756864000,"U235",null,null,true);
    public static Element Pu240 = new Element(94, 146, 0,1,19816,"plutonium_240", "Pu240",207002304000L,"U238",null, null,true);
    public static Element Pu241 = new Element(94, 147, 0,1,19816,"plutonium_241", "Pu241",441504000,"U237",null, "Am241",true);
    public static Element Pu242 = new Element(94, 148, 0,1,19816,"plutonium_242", "Pu242",11826000000000L,"U238",null, null,true);
    public static Element Pu243 = new Element(94, 149, 0,1,19816,"plutonium_243", "Pu243",18000, null,null,"Am243",true);
    public static Element Pu244 = new Element(94, 150, 0,1,19816,"plutonium_244", "Pu244",18000, "U240",null,null,true);
    public static Element Pu246 = new Element(94, 152, 0,1,19816,"plutonium_246", "Pu246",950400, null,null,"Am246",true);
    public static Element Am241 = new Element(95, 146, 0,1,13670,"americium_241","Am241", 13623552000L,"Np237",null,null,true);
    public static Element Am242 = new Element(95, 147, 0,1,13670,"americium_242", "Am242",57600, null,"Pu242","Cm242",true);
    public static Element Am244 = new Element(95, 149, 0,1,13670,"americium_244", "Am244",36000,null,null,"Cm244",true);
    public static Element Am246 = new Element(95, 151, 0,1,13670,"americium_246", "Am246",2340,null,null,"Cm246",true);
    public static Element Cm242 = new Element(96, 148, 0,1,13510,"curium_242", "Cm242",14083200,"Pu238",null,null,true);
    public static Element Cm244 = new Element(96, 150, 0,1,13510,"curium_244", "Cm244",567648000,"Pu240",null,null,true);
    public static Element Cm245 = new Element(96, 151, 0,1,13510,"curium_245", "Cm245",268056000000L,"Pu241",null,null,true);
    public static Element Cm246 = new Element(96, 152, 0,1,13510,"curium_246", "Cm246",149165280000L,"Pu242",null,null,true);
    public static Element Cm247 = new Element(96, 153, 0,1,13510,"curium_247", "Cm247",504576000000000L,"Pu243",null,null,true);
    public static Element Cm248 = new Element(96, 154, 0,1,13510,"curium_248", "Cm248",10974528000000L,"Pu244",null,null,true);
    public static Element Cm249 = new Element(96, 155, 0,1,13510,"curium_249", "Cm249",3840,null,null,"Bk249",true);
    public static Element Cm250 = new Element(96, 156, 0,1,13510,"curium_250", "Cm250",261748800000L,"Pu246",null,"Bk250",true);
    public static Element Bk248 = new Element(97, 151, 0,1,14780,"berkelium_248", "Bk248",283824000,"Am244","Cm248","Cf248",true);
    public static Element Bk249 = new Element(97, 152, 0,1,14780,"berkelium_249", "Bk249",28512000, null,null,"Cf249",true);
    public static Element Bk250 = new Element(97, 153, 0,1,14780,"berkelium_250", "Bk250",10800, null,null,"Cf250",true);
    public static Element Bk251 = new Element(97, 154, 0,1,14780,"berkelium_251", "Bk251",3360, null,null,"Cf251",true);
    public static Element Cf248 = new Element(98, 148, 0,1,15100,"californium_248", "Cf248",28857600,"Cm244",null,null,true);
    public static Element Cf249 = new Element(98, 149, 0,1,15100,"californium_249", "Cf249",11069136000L,"Cm245",null,null,true);
    public static Element Cf250 = new Element(98, 150, 0,1,15100,"californium_250", "Cf250",409968000,"Cm246",null,null,true);
    public static Element Cf251 = new Element(98, 151, 0,1,15100,"californium_251", "Cf251",28382400000L,"Cm247",null,null,true);
    public static Element Cf252 = new Element(98, 152, 0,1,15100,"californium_252", "Cf252",94608000,"Cm248",null,null,true);
    public static Element Cf253 = new Element(98, 155, 0,1,15100,"californium_253", "Cf253",94608000,"Cm249",null,"Es253",true);
    public static Element Cf254 = new Element(98, 156, 0,1,15100,"californium_254", "Cf254",5270400,"Cm250",null,null,true);
    public static Element Cf255 = new Element(98, 157, 0,1,15100,"californium_255", "Cf255",5100,null,null,"Es255",true);
    public static Element Es253 = new Element(99, 154, 0,1,8840,"einsteinium_253", "Es253",1728000, "Bk249",null,null,true);
    public static Element Es254 = new Element(99, 155, 0,1,8840,"einsteinium_254", "Es254",23846400, "Bk250",null,null,true);
    public static Element Es255 = new Element(99, 156, 0,1,8840,"einsteinium_255", "Es255",3456000,"Bk251",null,"Fm255",true);
    public static Element Es256 = new Element(99, 157, 0,1,8840,"einsteinium_256", "Es256",1500,null,null,"Fm256",true);
    public static Element Fm255 = new Element(100, 155, 0,1,1,"fermium_255", "Fm255",72000,"Cf251",null,null,true);
    public static Element Fm256 = new Element(100, 156, 0,1,1,"fermium_256", "Fm256",9480,"Cf252",null,null,true);
    public static Element Fm257 = new Element(100, 157, 0,1,1,"fermium_257", "Fm257",8726400,"Cf253",null,null,true);
     ...
     * @param decayIntoA        String representing the Element it decays to with alpha decay (either naturally, or forced).
     * @param decayIntoBP       String representing the Element it decays to with beta+ decay or electron capture, since both have the same consequences for the nuclide (either naturally, or forced).
     * @param decayIntoBM       String representing the Element it decays to with beta- decay (either naturally, or forced).
