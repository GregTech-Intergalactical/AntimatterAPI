...
public class Data {
    ...
    public static final AntimatterToolType WRENCH = new AntimatterToolType(Ref.ID, "wrench", 2, 2, 2, 1.5F, -2.8F, false).setUseSound(Ref.WRENCH).setOverlayLayers(0).setRepairability(false).setHasSecondaryMaterial(false);
    ...
    public static final AntimatterToolType CROWBAR = new AntimatterToolType(Ref.ID, "crowbar", 2, 10, 5, 1.0F, -2.0F, false).setUseSound(SoundEvents.ITEM_BREAK).setSecondaryRequirement(MaterialTags.RUBBERTOOLS).setRepairability(false).setHasSecondaryMaterial(false);
    ...
    public static final AntimatterToolType MORTAR = new AntimatterToolType(Ref.ID, "mortar", 5, 5, 2, -2.0F, 0.0F, false).setUseSound(SoundEvents.GRINDSTONE_USE).setBlockBreakability(false).setRepairability(false).setHasSecondaryMaterial(false);
