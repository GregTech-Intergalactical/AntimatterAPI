...
public abstract class AntimatterModelProvider<T extends AntimatterModelBuilder<T>> {
    ...
    public T withParent(String name, String parent) {
        return withParent(name, mcLoc(parent));
    }

    public T withParent(String name, ResourceLocation parent) {
    ...
    public T cubeTop(String name, ResourceLocation side, ResourceLocation top) {
        return withParent(name, BLOCK_FOLDER + "/cube_top")
                .texture("side", side)
                .texture("top", top);
    }
    ...
    public T orientableWithBottom(String name, ResourceLocation side, ResourceLocation front, ResourceLocation bottom, ResourceLocation top) {
        return withParent(name, BLOCK_FOLDER + "/orientable_with_bottom")
                .texture("side", side)
                .texture("front", front)
                .texture("bottom", bottom)
                .texture("top", top);
    ...
    public T orientable(String name, ResourceLocation side, ResourceLocation front, ResourceLocation top) {
        return withParent(name, BLOCK_FOLDER + "/orientable")
                .texture("side", side)
                .texture("front", front)
                .texture("top", top);
    }
    ...
    private T pane(String name, String parent, ResourceLocation pane, ResourceLocation edge) {
        return withParent(name, BLOCK_FOLDER + "/" + parent)
                .texture("pane", pane)
                .texture("edge", edge);
    }
    ...
    private T door(String name, String model, ResourceLocation bottom, ResourceLocation top) {
        return withParent(name, BLOCK_FOLDER + "/" + model)
                .texture("bottom", bottom)
                .texture("top", top);
    }
