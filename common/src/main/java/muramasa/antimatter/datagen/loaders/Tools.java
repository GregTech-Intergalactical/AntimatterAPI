...
public class Tools {
    public static void init(Consumer<FinishedRecipe> consumer, AntimatterRecipeProvider provider) {
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.HAMMER.getId()), consumer, Ref.ID, AntimatterDefaultTools.HAMMER.getId() + "_" + "recipe", "antimatter_tools",
                "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.HAMMER.getToolStack(Material.NULL, Material.NULL)), of('I', PropertyIngredient.builder("primary").types(INGOT, GEM).tool(AntimatterDefaultTools.HAMMER, true).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "II ", "IIR", "II ");
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.SOFT_HAMMER.getId()), consumer, Ref.ID, AntimatterDefaultTools.SOFT_HAMMER.getId() + "_" + "recipe", "antimatter_tools",
                "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.SOFT_HAMMER.getToolStack(Material.NULL, Material.NULL)), of('I', PropertyIngredient.builder("primary").types(INGOT, GEM).tool(AntimatterDefaultTools.SOFT_HAMMER, true).tags(RUBBERTOOLS).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "II ", "IIR", "II ");
        if (Material.get("wood") != Material.NULL && Material.get("wood").has(MaterialTags.TOOLS) && MaterialTags.TOOLS.getToolData(Material.get("wood")).toolTypes().contains(AntimatterDefaultTools.SOFT_HAMMER)) {
            provider.addToolRecipe(WOOD_TOOL_BUILDER.get(AntimatterDefaultTools.SOFT_HAMMER.getId()), consumer, Ref.ID, AntimatterDefaultTools.SOFT_HAMMER.getId() + "_wood_" + "recipe", "antimatter_tools",
                    "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.SOFT_HAMMER.getToolStack(Material.get("wood"), Material.NULL)), of('I', ItemTags.PLANKS, 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "II ", "IIR", "II ");
        }
        ...
        provider.addToolRecipe(ARMOR_BUILDER.get(AntimatterDefaultTools.HELMET.getId()), consumer, Ref.ID, AntimatterDefaultTools.HELMET.getId() + "_recipe", "antimatter_helmets",
                "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.HELMET.getToolStack(Material.NULL)), of('I', PropertyIngredient.builder("primary").types(PLATE, GEM).tags(MaterialTags.ARMOR).build(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "III", "IHI");
        provider.addToolRecipe(ARMOR_BUILDER.get(AntimatterDefaultTools.CHESTPLATE.getId()), consumer, Ref.ID, AntimatterDefaultTools.CHESTPLATE.getId() + "_recipe", "antimatter_chestplates",
                "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.CHESTPLATE.getToolStack(Material.NULL)), of('I', PropertyIngredient.builder("primary").types(PLATE, GEM).tags(MaterialTags.ARMOR).build(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "IHI", "III", "III");
        provider.addToolRecipe(ARMOR_BUILDER.get(AntimatterDefaultTools.LEGGINGS.getId()), consumer, Ref.ID, AntimatterDefaultTools.LEGGINGS.getId() + "_recipe", "antimatter_leggings",
                "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.LEGGINGS.getToolStack(Material.NULL)), of('I', PropertyIngredient.builder("primary").types(PLATE, GEM).tags(MaterialTags.ARMOR).build(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "III", "IHI", "I I");
        provider.addToolRecipe(ARMOR_BUILDER.get(AntimatterDefaultTools.BOOTS.getId()), consumer, Ref.ID, AntimatterDefaultTools.BOOTS.getId() + "_recipe", "antimatter_boots",
                "has_wrench", in, Collections.singletonList(AntimatterDefaultTools.BOOTS.getToolStack(Material.NULL)), of('I', PropertyIngredient.builder("primary").types(PLATE, GEM).tags(MaterialTags.ARMOR).build(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "I I", "IHI");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.WRENCH.getId()), consumer, Ref.ID, AntimatterDefaultTools.WRENCH.getId() + "_recipe", "antimatter_wrenches",
                "has_wrench", in, AntimatterDefaultTools.WRENCH.getToolStack(Material.NULL, Material.NULL), of('I', PropertyIngredient.builder("primary").types(PLATE, GEM).tool(AntimatterDefaultTools.WRENCH, true).build(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "IHI", "III", " I ");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.MORTAR.getId()), consumer, Ref.ID, AntimatterDefaultTools.MORTAR.getId() + "_recipe", "antimatter_mortars",
                "has_wrench", in, AntimatterDefaultTools.MORTAR.getToolStack(Material.NULL, Material.NULL), of('I', PropertyIngredient.builder("primary").types(INGOT, GEM).tool(AntimatterDefaultTools.MORTAR, true).build(), 'S', TagUtils.getForgelikeItemTag("stone")), " I ", "SIS", "SSS");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.FILE.getId()), consumer, Ref.ID, AntimatterDefaultTools.FILE.getId() + "_recipe", "antimatter_files",
                "has_wrench", in, AntimatterDefaultTools.FILE.getToolStack(Material.NULL, Material.NULL), of('P', PropertyIngredient.builder("primary").types(PLATE, GEM).tool(AntimatterDefaultTools.FILE, true).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "P", "P", "R");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.SAW.getId()), consumer, Ref.ID, AntimatterDefaultTools.SAW.getId() + "_recipe", "antimatter_saws",
                "has_wrench", in, AntimatterDefaultTools.SAW.getToolStack(Material.NULL, Material.NULL), of('P', PropertyIngredient.builder("primary").types(PLATE, GEM).tool(AntimatterDefaultTools.SAW, true).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build(), 'F', AntimatterDefaultTools.FILE.getTag(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "PPR", "FH ");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.KNIFE.getId()), consumer, Ref.ID, AntimatterDefaultTools.KNIFE.getId() + "_with", "antimatter_knives",
                "has_wrench", in, AntimatterDefaultTools.KNIFE.getToolStack(Material.NULL, Material.NULL), of('P', PropertyIngredient.builder("primary").inverse().tags(FLINT).types(PLATE, GEM).tool(AntimatterDefaultTools.KNIFE, true).build(), 'S', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build(), 'F', AntimatterDefaultTools.FILE.getTag(), 'H', AntimatterDefaultTools.HAMMER.getTag()), "FP", "HS");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.PICKAXE.getId()), consumer, Ref.ID, "flint_" + AntimatterDefaultTools.PICKAXE.getId() + "_" + "recipe", "antimatter_tools",
                "has_flint", provider.hasSafeItem(GEM.getMaterialTag(AntimatterMaterials.Flint)), AntimatterDefaultTools.PICKAXE.getToolStack(AntimatterMaterials.Flint, Material.NULL), of('I', PropertyIngredient.builder("primary").types(GEM).tags(FLINT).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "III", " R ", " R ");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.AXE.getId()), consumer, Ref.ID, "flint_" + AntimatterDefaultTools.AXE.getId() + "_" + "recipe", "antimatter_tools",
                "has_flint", provider.hasSafeItem(GEM.getMaterialTag(AntimatterMaterials.Flint)), AntimatterDefaultTools.AXE.getToolStack(AntimatterMaterials.Flint, Material.NULL), of('I', PropertyIngredient.builder("primary").types(GEM).tags(FLINT).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "II", "IR", " R");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.SWORD.getId()), consumer, Ref.ID, "flint_" + AntimatterDefaultTools.SWORD.getId() + "_" + "recipe", "antimatter_tools",
                "has_flint", provider.hasSafeItem(GEM.getMaterialTag(AntimatterMaterials.Flint)), AntimatterDefaultTools.SWORD.getToolStack(AntimatterMaterials.Flint, Material.NULL), of('I', PropertyIngredient.builder("primary").types(GEM).tags(FLINT).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "I", "I", "R");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.SHOVEL.getId()), consumer, Ref.ID, "flint_" + AntimatterDefaultTools.SHOVEL.getId() + "_" + "recipe", "antimatter_tools",
                "has_flint", provider.hasSafeItem(GEM.getMaterialTag(AntimatterMaterials.Flint)), AntimatterDefaultTools.SHOVEL.getToolStack(AntimatterMaterials.Flint, Material.NULL), of('I', PropertyIngredient.builder("primary").types(GEM).tags(FLINT).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "I", "R", "R");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.HOE.getId()), consumer, Ref.ID, "flint_" + AntimatterDefaultTools.HOE.getId() + "_" + "recipe", "antimatter_tools",
                "has_flint", provider.hasSafeItem(GEM.getMaterialTag(AntimatterMaterials.Flint)), AntimatterDefaultTools.HOE.getToolStack(AntimatterMaterials.Flint, Material.NULL), of('I', PropertyIngredient.builder("primary").types(GEM).tags(FLINT).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "II", " R", " R");
        ...
        provider.addToolRecipe(TOOL_BUILDER.get(AntimatterDefaultTools.KNIFE.getId()), consumer, Ref.ID, "flint_" + AntimatterDefaultTools.KNIFE.getId() + "_" + "recipe", "antimatter_tools",
                "has_flint", provider.hasSafeItem(GEM.getMaterialTag(AntimatterMaterials.Flint)), AntimatterDefaultTools.KNIFE.getToolStack(AntimatterMaterials.Flint, Material.NULL), of('I', PropertyIngredient.builder("primary").types(GEM).tags(FLINT).build(), 'R', PropertyIngredient.builder("secondary").types(ROD).tags(HANDLE).build()), "RI");
    }
}
