...
public interface IForgeTagAppender<T>
{
    ...
    default TagsProvider.TagAppender<T> replace(boolean value) {
        getInternalBuilder().replace(value);
        return self();
    }
    ...
    {
        return remove(this.getRegistry().getKey(entry));
    }
    ...
    {
        TagsProvider.TagAppender<T> builder = self();
        getInternalBuilder().removeElement(location, getModID());
        return builder;
    }
    ...
    {
        TagsProvider.TagAppender<T> builder = self();
        getInternalBuilder().removeTag(tag.location(), getModID());
        return builder;
    }
    ...
    default Tag.Builder getInternalBuilder() {
