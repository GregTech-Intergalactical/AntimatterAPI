...
public interface IForgeRawTagBuilder
{
    ...
    // injected
    default Stream<Tag.BuilderEntry> getRemoveEntries() {
        throw new UnsupportedOperationException("Implemented via mixin");
    }
    default Tag.Builder remove(final Tag.BuilderEntry proxy) { // internal forge method for adding remove entries
        throw new UnsupportedOperationException("Implemented via mixin");
    }

    default Tag.Builder replace(boolean value) {
        throw new UnsupportedOperationException("Implemented via mixin");
    }

    default Tag.Builder replace() {
        return replace(true);
    }
}
