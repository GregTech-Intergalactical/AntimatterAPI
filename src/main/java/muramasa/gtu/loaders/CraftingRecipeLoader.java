...
public class CraftingRecipeLoader {
    ...
    public static void init() {
        ...
        RecipeHelper.addShaped("gear_wood", Materials.Wood.getGear(1), "SPS", "PwP", "SPS", 'P', Materials.Wood.getPlate(1), 'S', "stickWood");   
        RecipeHelper.addShaped("gear_stone", Materials.Stone.getGear(1), "SPS", "PhP", "SPS", 'P', Blocks.COBBLESTONE, 'S', Blocks.STONE); 
    }
}
