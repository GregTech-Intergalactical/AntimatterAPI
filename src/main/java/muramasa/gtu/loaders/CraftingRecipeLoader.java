...
public class CraftingRecipeLoader {
    ...
    public static void init() {
        ...
        RecipeHelper.addShaped("mortar_flint", ToolType.MORTAR.get(Flint), " F ", "SFS", "SSS", 'F', Items.FLINT, 'S', "stone");
        ...
        RecipeHelper.addShapeless("rubber_ring", Rubber.getRing(1), ToolType.KNIFE.getOreDict(), Rubber.getPlate(1));
        RecipeHelper.addShapeless("styrene_butadiene_rubber_ring", StyreneButadieneRubber.getRing(1), ToolType.KNIFE.getOreDict(), StyreneButadieneRubber.getPlate(1));
