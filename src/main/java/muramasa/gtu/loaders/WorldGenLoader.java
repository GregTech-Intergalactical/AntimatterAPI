...
public class WorldGenLoader {
    ...
    public static void init() {
        ...
        new WorldGenOreVein("platinum", 40, 50, 5, 3, 16, Sheldonite, Palladium, Platinum, Iridium, OVERWORLD, END);
        ...
        new WorldGenOreVein("sapphire", 10, 40, 60, 3, 16, Almandine, Pyrope, Sapphire, GreenSapphire, OVERWORLD);
