...
public class UndergroundBiomesRegistrar implements IGregTechRegistrar {
    ...
    //UB Igneous
    public static StoneType UB_RED_GRANIITE = new StoneType("ub_red_granite", "granite_red", Ref.MOD_UB, Materials.Stone, false, new Texture(Ref.MOD_UB, "blocks/red_granite"), SoundType.STONE);
    public static StoneType UB_BLACK_GRANIITE = new StoneType("ub_black_granite", "granite_black", Ref.MOD_UB, Materials.Stone, false, new Texture(Ref.MOD_UB, "blocks/black_granite"), SoundType.STONE);
    ...
    public static StoneType UB_BASALT = new StoneType("ub_basalt", "basalt", Ref.MOD_UB, Materials.Stone, false, new Texture(Ref.MOD_UB, "blocks/basalt"), SoundType.STONE);
    ...
    public static StoneType UB_MARBLE = new StoneType("ub_marble", "marble", Ref.MOD_UB, Materials.Stone, false, new Texture(Ref.MOD_UB, "blocks/marble"), SoundType.STONE);
    ...
    public void onRegistrationEvent(RegistrationEvent event) {
        switch (event) {
            /*case DATA:
                BlockOre.addStoneSet("ub_1", new StoneType[] {
                        UB_RED_GRANIITE, UB_BLACK_GRANIITE, UB_RHYOLITE, UB_ANDESITE, UB_GABBRO, UB_BASALT, UB_KOMATIITE, UB_DACITE, UB_GNEISS, UB_ECLOGITE, UB_MARBLE, UB_QUARTZITE, 
                        UB_BLUE_SCHIST, UB_GREEN_SCHIST, UB_SOAPSTONE  
                });
                BlockOre.addStoneSet("ub_2", new StoneType[] {
                        UB_MIGMATITE, UB_LIMESTONE, UB_CHALK, UB_SHALE, UB_SILTSTONE, UB_LIGNITE, UB_DOLOMITE, UB_GREYWACKE, UB_CHERT
                });
                break;*/
            case INIT:
                break;
