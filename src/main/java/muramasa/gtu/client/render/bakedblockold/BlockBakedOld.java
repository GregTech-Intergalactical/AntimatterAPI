...
//    }
//
//    private TextureData getData(BlockState state, IBlockReader world, BlockPos pos) {
//        TextureData data = hasTileEntity(state) ? getTileData(state, world, pos) : getDefaultData();
//        return data != null ? data : defaultData;
//    }
//
//    @Nullable
//    public TextureData getTileData(BlockState state, IBlockReader world, BlockPos pos) {
