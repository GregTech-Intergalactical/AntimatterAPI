...
//            baked.add(new BakedBase(textured.bake(TRSRTransformation.from(Direction.NORTH), format, getter), StoneType.STONE.getTexture()));
//            baked.add(new BakedBase(textured.bake(TRSRTransformation.from(Direction.EAST), format, getter), StoneType.STONE.getTexture()));
//            baked.add(new BakedBase(textured.bake(TRSRTransformation.from(Direction.SOUTH), format, getter), StoneType.STONE.getTexture()));
//            baked.add(new BakedBase(textured.bake(TRSRTransformation.from(Direction.WEST), format, getter), StoneType.STONE.getTexture()));
//        }
