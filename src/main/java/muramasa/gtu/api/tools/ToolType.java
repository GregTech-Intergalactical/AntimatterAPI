...
public enum ToolType implements IGregTechObject {
    ...
    CROWBAR("Crowbar", "Removes Covers", "craftingToolCrowbar", null, Sets.newHashSet("crowbar"), Sounds.BREAK, false, 0, 2.0f, -3.0f, 1.0f, 1.0f, 50, 200, 100),
    ...
    DRILL("Electric Drill", "", "craftingToolDrill", null, Sets.newHashSet("drill", "pickaxe"), Sounds.DRILL, true, 1, 3.0f, -2.8f, 9.0f, 4.0f, 800, 3200, 12800),
    ...
    WRENCH_P("Electric Wrench", "", "craftingToolWrench", null, Sets.newHashSet("wrench"), Sounds.WRENCH, true, 1, 2.0f, -2.4f, 4.0f, 4.0f, 800, 3200, 12800),
    ...
    SCREWDRIVER_P("Electric Screwdriver", "", "craftingToolScrewdriver", null, Sets.newHashSet("screwdriver"), Sounds.WRENCH, true, 0, 1.0f, -2.4f, 1.0f, 1.0f, 100, 200, 200),
    ...
    ToolType(String displayName, String tooltip, String oreDict, Class toolClass, Set<String> toolClasses, Sounds useSound, boolean powered, int baseQuality, float baseAttackDamage, float baseAttackSpeed, float miningSpeedMulti, float duraMulti, int damageMining, int damageEntity, int damageCrafting) {
