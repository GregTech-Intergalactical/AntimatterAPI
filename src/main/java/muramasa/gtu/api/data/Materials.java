...
public class Materials {
    ...
    public static Material Graphite = new Material("graphite", 0x808080, DULL).asDust(ORE, ORE_SMALL);
    ...
    public static Material Almandine = new Material("almandine", 0xff0000, ROUGH).asDust(ORE, ORE_SMALL).add(Aluminium, 2, Iron, 3, Silicon, 3, Oxygen, 12);
    public static Material Andradite = new Material("andradite", 0x967800, ROUGH).asDust(ORE, ORE_SMALL).add(Calcium, 3, Iron, 2, Silicon, 3, Oxygen, 12);
    ...
    public static Material Cassiterite = new Material("cassiterite", 0xdcdcdc, METALLIC).asDust(ORE, ORE_SMALL).add(Tin, 1, Oxygen, 2);
    public static Material Chalcopyrite = new Material("chalcopyrite", 0xa07828, DULL).asDust(ORE, ORE_SMALL).add(Copper, 1, Iron, 1, Sulfur, 2);
    ...
    public static Material Cooperite = new Material("cooperite", 0xffffc8, METALLIC).asDust(ORE, ORE_SMALL).add(Platinum, 3, Nickel, 1, Sulfur, 1, Palladium, 1);
    public static Material DarkAsh = new Material("dark_ash", 0x323232, DULL).asDust();
    public static Material Galena = new Material("galena", 0x643c64, DULL).asDust(ORE, ORE_SMALL).add(Lead, 3, Silver, 3, Sulfur, 2);
    public static Material Garnierite = new Material("garnierite", 0x32c846, METALLIC).asDust(ORE, ORE_SMALL).add(Nickel, 1, Oxygen, 1);
    public static Material Grossular = new Material("grossular", 0xc86400, ROUGH).asDust(ORE, ORE_SMALL).add(Calcium, 3, Aluminium, 2, Silicon, 3, Oxygen, 12);
    ...
    public static Material Pyrite = new Material("pyrite", 0x967828, ROUGH).asDust(ORE, ORE_SMALL).add(Iron, 1, Sulfur, 2);
    public static Material Pyrolusite = new Material("pyrolusite", 0x9696aa, DULL).asDust(ORE, ORE_SMALL).add(Manganese, 1, Oxygen, 2);
    public static Material Pyrope = new Material("pyrope", 0x783264, METALLIC).asDust(ORE, ORE_SMALL).add(Aluminium, 2, Magnesium, 3, Silicon, 3, Oxygen, 12);
    public static Material RockSalt = new Material("rock_salt", 0xf0c8c8, FINE).asDust(ORE, ORE_SMALL).add(Potassium, 1, Chlorine, 1);
    public static Material RawRubber = new Material("raw_rubber", 0xccc789, DULL).asDust().add(Carbon, 5, Hydrogen, 8);
    public static Material Salt = new Material("salt", 0xfafafa, FINE).asDust(ORE, ORE_SMALL).add(Sodium, 1, Chlorine, 1);
    public static Material Saltpeter = new Material("saltpeter", 0xe6e6e6, FINE).asDust(ORE, ORE_SMALL).add(Potassium, 1, Nitrogen, 1, Oxygen, 3);
    ...
    public static Material Spessartine = new Material("spessartine", 0xff6464, DULL).asDust(ORE, ORE_SMALL).add(Aluminium, 2, Manganese, 3, Silicon, 3, Oxygen, 12);
    public static Material Sphalerite = new Material("sphalerite", 0xffffff, DULL).asDust(ORE, ORE_SMALL).add(Zinc, 1, Sulfur, 1);
    public static Material Stibnite = new Material("stibnite", 0x464646, METALLIC).asDust(ORE, ORE_SMALL).add(Antimony, 2, Sulfur, 3);
    ...
    public static Material Uvarovite = new Material("uvarovite", 0xb4ffb4, DIAMOND).asDust(ORE, ORE_SMALL).add(Calcium, 3, Chrome, 2, Silicon, 3, Oxygen, 12);
    ...
    public static Material Pentlandite = new Material("pentlandite", 0xa59605, DULL).asDust(ORE, ORE_SMALL).add(Nickel, 9, Sulfur, 8);
    ...
    //Brittle Gems
    public static Material BlueTopaz = new Material("blue_topaz", 0x0000ff, GEM_H).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 3).add(Aluminium, 2, Silicon, 1, Fluorine, 2, Hydrogen, 2, Oxygen, 6);
    public static Material Charcoal = new Material("charcoal", 0x644646, LIGNITE).asGemBasic(false).add(Carbon, 1);
    public static Material Coal = new Material("coal", 0x464646, LIGNITE).asGemBasic(false, ORE, ORE_SMALL).add(Carbon, 1);
    ...
    public static Material BlueSapphire = new Material("blue_sapphire", 0x6464c8, GEM_V).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).add(Aluminium, 2, Oxygen, 3);
    ...
    public static Material Tanzanite = new Material("tanzanite", 0x4000c8, GEM_V).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).add(Calcium, 2, Aluminium, 3, Silicon, 3, Hydrogen, 1, Oxygen, 13);
    public static Material Topaz = new Material("topaz", 0xff8000, GEM_H).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).add(Aluminium, 2, Silicon, 1, Fluorine, 2, Hydrogen, 2, Oxygen, 6);
    ...
    public static Material Opal = new Material("opal", 0x0000ff, RUBY).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 2).add(SiliconDioxide, 1);
    public static Material Amethyst = new Material("amethyst", 0xd232d2, RUBY).asGem(true, ORE, ORE_SMALL).addTools(7.0F, 256, 3).add(SiliconDioxide, 4, Iron, 1);
    ...
    public static Material GarnetRed = new Material("red_garnet", 0xc85050, RUBY).asGemBasic(true, ORE, ORE_SMALL).add(Pyrope, 3, Almandine, 5, Spessartine, 8);
    public static Material GarnetYellow = new Material("yellow_garnet", 0xc8c850, RUBY).asGemBasic(true, ORE, ORE_SMALL).add(Andradite, 5, Grossular, 8, Uvarovite, 3);
