...
public class Materials {
    ...
    public static Material Plutonium = new Material("plutonium_244", 0xf03232, METALLIC, Pu).asMetal(912, 0).addTools(6.0F, 512, 3);
    public static Material Plutonium241 = new Material("plutonium_241", 0xfa4646, SHINY, Pu241).asMetal(912, 0).addTools(6.0F, 512, 3);
    ...
    public static Material Uranium = new Material("uranium_238", 0x32f032, METALLIC, U).asMetal(1405, 0, ORE).addTools(6.0F, 512, 3);
    ...
    public static Material CharcoalByproducts = new Material("charcoal_byproducts", 0x784421, NONE).asFluid(); //TODO rename
    public static Material FermentedBiomass = new Material("fermented_biomass", 0x445500, NONE).asFluid(); //TODO needed?
    ...
    public static Material WoodTar = new Material("wood_tar", 0x28170b, NONE).asFluid();
    ...
    public static Material SaltWater = new Material("salt_water", 0x0000c8, NONE).asFluid(); //TODO needed?
    ...
    public static Material GrowthMediumRaw = new Material("raw_growth_medium", 0xd38d5f, NONE).asFluid(); //TODO needed?
    public static Material GrowthMediumSterilized = new Material("growth_medium_sterilized", 0xdeaa87, NONE).asFluid(); //TODO needed?
    ...
    //TODO
    public static Material DrillingFluid = new Material("drilling_fluid", 0xffffff, NONE).asFluid();
    ...
    public static Material MetalMixture = new Material("metal_mixture", 0x502d16, METALLIC).asDust();
    ...
    public static Material WoodSealed = new Material("sealed_wood", 0x502800, NONE).asDust().addTools(3.0F, 24, 0).add(Wood, 1);
    ...
    /** Gems **/
    public static Material CertusQuartz = new Material("certus_quartz", 0xd2d2e6, QUARTZ).asGemBasic(false, PLATE, ORE).addTools(5.0F, 32, 1);
    ...
    public static Material NetherStar = new Material("nether_star", 0xffffff, NONE).asGemBasic(false).addTools(1.0F, 5120, 4);
    ...
    /** Metals **/
    public static Material AnnealedCopper = new Material("annealed_copper", 0xff7814, SHINY).asMetal(1357, 0, PLATE, FOIL, ROD, WIREF).add(Copper, 1);
    ...
    public static Material NiobiumTitanium = new Material("niobium_titanium", 0x1d1d29, DULL).asMetal(4500, 4500, PLATE, FOIL, ROD, WIREF).add(Nickel, 4, Chrome, 1);
    public static Material PigIron = new Material("pig_iron", 0xc8b4b4, METALLIC).asMetal(1420, 0).addTools(6.0F, 384, 2).add(Iron, 1);
    public static Material SolderingAlloy = new Material("soldering_alloy", 0xdcdce6, DULL).asMetal(400, 400, PLATE, FOIL, ROD, WIREF).add(Tin, 9, Antimony, 1);
    public static Material StainlessSteel = new Material("stainless_steel", 0xc8c8dc, SHINY).asMetal(1700, 1700, SCREW, GEAR, SGEAR, FRAME).addTools(7.0F, 480, 2).add(Iron, 6, Chrome, 1, Manganese, 1, Nickel, 1);
    ...
    public static Material WroughtIron = new Material("wrought_iron", 0xc8b4b4, METALLIC).asMetal(1811, 0, RING, FRAME).addTools(6.0F, 384, 2).add(Iron, 1);
    public static Material YttriumBariumCuprate = new Material("yttrium_barium_cuprate", 0x504046, METALLIC).asMetal(4500, 4500, PLATE, FOIL, ROD, WIREF).add(Yttrium, 1, Barium, 2, Copper, 3, Oxygen, 7);
    ...
    public static Material BismuthBronze = new Material("bismuth_bronze", 0x647d7d, DULL).asMetal(1100, 1100).addTools(8.0F, 256, 2).add(Bismuth, 1, Zinc, 1, Copper, 3);
    ...
    public static Material RedAlloy = new Material("red_alloy", 0xc80000, DULL).asMetal(295, 0, PLATE, FOIL, ROD, WIREF).add(Copper, 1, Redstone, 4);
    ...
    public static Material NaquadahEnriched = new Material("naquadah_enriched", 0x323232, METALLIC).asMetal(4500, 4500, ORE).addTools(6.0F, 1280, 4); //TODO ORE flag added due to bee recipes, replace with OrePrefixes.mGeneratedItems
