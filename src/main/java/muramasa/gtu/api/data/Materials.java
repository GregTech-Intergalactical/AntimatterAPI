...
public class Materials {
    ...
    public static Material Electrum = new Material("electrum", 0xffff64, SHINY).asMetal(1330, 0, PLATE, FOIL, ROD, FINE_WIRE).addTools(13.0F, 48, 2, of(Enchantments.UNBREAKING, 3)).add(Silver, 1, Gold, 1);
