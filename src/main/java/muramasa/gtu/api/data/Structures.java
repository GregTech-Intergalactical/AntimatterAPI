...
public class Structures {
    ...
    public static void init() {
        ...
        BLAST_FURNACE.setStructure(new StructureBuilder()
            ...
            .at("M", BLAST_FURNACE).at("B", "coil", GregTechRegistry.getAll(BlockCoil.class)).at("C", CASING_HEAT_PROOF, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_FLUID_I, HATCH_FLUID_O, HATCH_ENERGY)
        ...
        MULTI_SMELTER.setStructure(new StructureBuilder()
            ...
            .at("M", MULTI_SMELTER).at("B", "coil", GregTechRegistry.getAll(BlockCoil.class)).at("C", CASING_HEAT_PROOF, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
            .build().offset(2, 0).min(12, CASING_HEAT_PROOF).min(1, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
        );
        ...
        PYROLYSIS_OVEN.setStructure(new StructureBuilder()
            ...
            .at("M", PYROLYSIS_OVEN).at("S", CASING_ULV).at("C", GregTechRegistry.getAll(BlockCoil.class)).at("B", CASING_ULV, HATCH_ITEM_O, HATCH_ENERGY).at("T", CASING_ULV, HATCH_ITEM_I).at("Y", HATCH_MUFFLER)
