...
public class Structures {
    ...
    public static void init() {
        ...
        PRIMITIVE_BLAST_FURNACE.setStructure(new StructureBuilder()
            ...
            .build().offset(2, -1).min(32, FIRE_BRICK)
        );
        BRONZE_BLAST_FURNACE.setStructure(new StructureBuilder()
            ...
            .build().offset(2, -1).min(32, BRONZE_PLATED_BRICK)
        );
        BLAST_FURNACE.setStructure(new StructureBuilder()
            .of("CCC", "CCM", "CCC").of("BBB", "BAB", "BBB").of(1).of("CCC", "CCC", "CCC")
            .at("M", BLAST_FURNACE).at("B", "coil", Coil.getAll()).at("C", HEAT_PROOF, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_FLUID_I, HATCH_FLUID_O, HATCH_ENERGY)
            .build().offset(2, 0).min(12, HEAT_PROOF).min(1, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
        );
        MULTI_SMELTER.setStructure(new StructureBuilder()
            .of("CCC", "CCM", "CCC").of("BBB", "BAB", "BBB").of("CCC", "CCC", "CCC")
            .at("M", MULTI_SMELTER).at("B", "coil", Coil.getAll()).at("C", HEAT_PROOF, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
            .build().offset(2, 0).min(12, HEAT_PROOF).min(1, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
        );
        VACUUM_FREEZER.setStructure(new StructureBuilder()
            ...
            .build().offset(2, -1).min(22, FROST_PROOF).min(1, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
        );
        IMPLOSION_COMPRESSOR.setStructure(new StructureBuilder()
            .of("CCC", "CCC", "CCC").of("CCC", "CAM", "CCC").of(0)
            .at("M", IMPLOSION_COMPRESSOR).at("C", SOLID_STEEL, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
            .build().offset(2, -1).min(16, SOLID_STEEL).min(1, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY)
        );
        PYROLYSIS_OVEN.setStructure(new StructureBuilder()
            ...
            .at("M", PYROLYSIS_OVEN).at("S", ULV).at("C", Coil.getAll()).at("B", ULV, HATCH_ITEM_O, HATCH_ENERGY).at("T", ULV, HATCH_ITEM_I).at("Y", HATCH_MUFFLER)
            .build().offset(4, 0).min(60, ULV).min(1, HATCH_ITEM_I, HATCH_ITEM_O, HATCH_ENERGY, HATCH_MUFFLER)
        );
        LARGE_TURBINE.setStructure(new StructureBuilder()
            ...
            .build().offset(3, -1).min(28, TURBINE_4).min(1, HATCH_FLUID_I, HATCH_FLUID_O)
        );
        COMBUSTION_ENGINE.setStructure(new StructureBuilder()
            ...
            .build().offset(3, -1).min(19, TITANIUM).min(1, HATCH_FLUID_I, HATCH_FLUID_O)
        );
        //TODO Tier sensitive...
