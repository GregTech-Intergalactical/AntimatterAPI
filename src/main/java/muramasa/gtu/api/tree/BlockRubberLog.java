...
public class BlockRubberLog extends BlockLogBase {
    ...
    public static PropertyDirection RESIN_FACING = PropertyDirection.create("resin_facing", Arrays.asList(EnumFacing.HORIZONTALS));

    public BlockRubberLog() {
        super(new ResourceLocation(Ref.MODID, "rubber_log"));
        setDefaultState(getDefaultState().withProperty(RESIN_STATE, ResinState.NONE).withProperty(RESIN_FACING, EnumFacing.NORTH));
    }
