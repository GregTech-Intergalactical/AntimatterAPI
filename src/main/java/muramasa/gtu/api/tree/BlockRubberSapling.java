...
//                placeTree(world, aX, tY, aZ, Data.RUBBER_LOG.getDefaultState().withProperty(BlockRubberLog.RESIN_STATE, BlockRubberLog.ResinState.EMPTY).withProperty(BlockRubberLog.RESIN_FACING, Direction.HORIZONTALS[rand.nextInt(4)]));
//            }
...
//    }
//
//    public static boolean placeTree(World world, int x, int y, int z, BlockState state) {
