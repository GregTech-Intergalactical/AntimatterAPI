...
public class MachineTankHandlerOld implements IFluidTank, IFluidHandler {
    ...
    public MachineTankHandlerOld(TileEntityMachine tile, int capacity, FluidStack fluidStack, boolean canFill, boolean canDrain) {
        this.tile = tile;
