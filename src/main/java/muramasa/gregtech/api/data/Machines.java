...
public class Machines {
    ...
    public static Machine ALLOY_SMELTER = new BasicMachine("alloy_smelter");
    public static Machine ASSEMBLER = new BasicMachine("assembler");
    public static Machine BENDER = new BasicMachine("bender");
    public static Machine CANNER = new BasicMachine("canner");
    public static Machine COMPRESSOR = new BasicMachine("compressor");
    public static Machine CUTTER = new BasicMachine("cutter");
    public static Machine FURNACE = new BasicMachine("furnace");
    public static Machine EXTRACTOR = new BasicMachine("extractor");
    public static Machine EXTRUDER = new BasicMachine("extruder");
    public static Machine LATHE = new BasicMachine("lathe");
    public static Machine PULVERIZER = new BasicMachine("pulverizer");
    public static Machine RECYCLER = new BasicMachine("recycler");
    public static Machine SCANNER = new ItemFluidMachine("scanner");
    public static Machine WIRE_MILL = new BasicMachine("wire_mill");
    ...
    public static Machine THERMAL_CENTRIFUGE = new BasicMachine("thermal_centrifuge");
    ...
    public static Machine DISASSEMBLER = new BasicMachine("disassembler");
    public static Machine MASS_FABRICATOR = new ItemFluidMachine("mass_fabricator");
    public static Machine AMP_FABRICATOR = new BasicMachine("amp_fabricator");
    ...
    public static Machine FLUID_EXTRACTOR = new BasicMachine("fluid_extractor");
    ...
    public static Machine LASER_ENGRAVER = new BasicMachine("laser_engraver");
    public static Machine FORMING_PRESS = new BasicMachine("forming_press");
    public static Machine FORGE_HAMMER = new BasicMachine("forge_hammer");
    public static Machine SIFTER = new BasicMachine("sifter");
