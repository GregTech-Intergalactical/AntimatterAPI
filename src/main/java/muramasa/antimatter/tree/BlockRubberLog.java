...
public class BlockRubberLog extends BlockBasic {
    ...
    public BlockRubberLog() {
        super(Ref.ID, "rubber_log", Block.Properties.create(Material.WOOD).hardnessAndResistance(2.0F).sound(SoundType.WOOD),
                new Texture(Ref.ID, "tree/rubber_log"));
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context) {
        ...
        return this.getDefaultState().with(AXIS, context.getFace().getAxis())
                .with(RESIN_FACING, context.getPlacementHorizontalFacing().getOpposite()).with(RESIN_STATE, ResinState.FILLED);
    }
