...
public class Data {
    ...
    public static final AntimatterToolType SHOVEL = new AntimatterToolType(Ref.ID, "shovel", 1, 2, 10, 1.5F, -3.0F, true).addEffectiveMaterials(CLAY, net.minecraft.world.level.material.Material.SAND, TOP_SNOW, SNOW, DIRT).setHasContainer(false);
    ...
    public static final AntimatterToolType DRILL = new AntimatterToolType(Ref.ID, "drill", 2, 2, 10, 3.0F, -3.0F, false).setPowered(100000, 1, 2, 3).setUseSound(Ref.DRILL).addTags("pickaxe", "shovel").addEffectiveMaterials(ICE_SOLID, net.minecraft.world.level.material.Material.METAL, net.minecraft.world.level.material.Material.STONE, HEAVY_METAL, PISTON, DIRT, CLAY, net.minecraft.world.level.material.Material.SAND).setRepairability(false);
    ...
    public static final AntimatterToolType CHAINSAW = new AntimatterToolType(Ref.ID, "chainsaw", 2, 1, 5, 3.0F, -2.0F, false).setPowered(100000, 1, 2, 3).addEffectiveMaterials(WOOD, PLANT, REPLACEABLE_PLANT, BAMBOO, LEAVES).addTags("axe", "saw");
    ...
    public static final AntimatterToolType JACKHAMMER = new AntimatterToolType(Ref.ID, "jackhammer", 2, 2, 10, 1.0F, -3.2F, false).setPowered(100000, 1, 2, 3).setUseSound(Ref.DRILL).addEffectiveMaterials(net.minecraft.world.level.material.Material.STONE, DIRT, net.minecraft.world.level.material.Material.SAND, GRASS);
