...
public class Data {
    ...
    public static final AntimatterToolType DRILL = new AntimatterToolType(Ref.ID, "drill", 2, 2, 10, 3.0F, -3.0F, false).setType(PICKAXE).setUseAction(UseAnim.BLOCK).setPowered(100000, 1, 2, 3).setUseSound(Ref.DRILL).addTags("pickaxe", "shovel").addEffectiveMaterials(ICE_SOLID, net.minecraft.world.level.material.Material.METAL, net.minecraft.world.level.material.Material.STONE, HEAVY_METAL, PISTON, DIRT, CLAY, net.minecraft.world.level.material.Material.SAND).setRepairability(false);
