...
public class ButtonType {
    ...
    public static ButtonType DOUBLE_SWITCH_BODY = new ButtonType("double_switch", (l, t, h, i, r, b) -> new SwitchWidjet(false, r, l + b.getX(), t + b.getY(), b.getW(), b.getH(), b.getBody(0), b.getBody(1), getSwitchable(h, i, b))); // Switch with two bodies which changes on the toggle
    public static ButtonType SINGLE_SWITCH_BODY = new ButtonType("single_switch", (l, t, h, i, r, b) -> new SwitchWidjet(false, r, l + b.getX(), t + b.getY(), b.getW(), b.getH(), b.getOverlay(0), getSwitchable(h, i, b))); // Switch with single body which change coloring on the toggle
    public static ButtonType TEXT_ON_SWITCH = new ButtonType("text_switch", (l, t, h, i, r, b) -> new SwitchWidjet(false, r, l + b.getX(), t + b.getY(), b.getW(), b.getH(), b.getOverlay(0), b.getText(), getSwitchable(h, i, b))); // Switch with single body which change coloring on the toggle and text above
    public static ButtonType OVERLAY_ON_SWITCH = new ButtonType("over_switch", (l, t, h, i, r, b) -> new SwitchWidjet(false, r, l + b.getX(), t + b.getY(), b.getW(), b.getH(), b.getBody(0), b.getOverlay(1), getSwitchable(h, i, b))); // Switch with body and overlay above
    public static ButtonType DOUBLE_OVERLAY_ON_BODY  = new ButtonType("2over_switch", (l, t, h, i, r, b) -> new SwitchWidjet(false, r, l + b.getX(), t + b.getY(), b.getW(), b.getH(), b.getBody(0), b.getOverlay(1), b.getOverlay(2), getSwitchable(h, i, b))); // Switch with body and overlay which switch on the toggle
