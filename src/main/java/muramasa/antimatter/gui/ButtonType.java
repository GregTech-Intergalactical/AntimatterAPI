...
public class ButtonType {
    ...
    public static ButtonType SINGLE_SWITCH_BODY = new ButtonType("single_switch", (l, t, h, i, r, b) -> new SwitchWidjet(r, l + b.getX(), t + b.getY(), b.getW(), b.getH(), b.getOverlay(0), getSwitchable(h, i, b),false)); // Switch with single body which change coloring on the toggle
