...
public class SlotType {
    ...
    public static SlotType IT_IN = new SlotType("item_in", (t, i, d) -> Optional.of(new SlotInput(t.itemHandler.map(MachineItemHandler::getInputHandler).orElse(null), i, d.getX(), d.getY())));
    public static SlotType IT_OUT = new SlotType("item_out", (t, i, d) -> Optional.of(new SlotOutput(t.itemHandler.map(MachineItemHandler::getOutputHandler).orElse(null), i, d.getX(), d.getY())));
    ...
    public static SlotType CELL_IN = new SlotType("cell_in", (t, i, d) -> Optional.of(new SlotCell(t.itemHandler.map(MachineItemHandler::getCellHandler).orElse(null), i, d.getX(), d.getY())));
    public static SlotType CELL_OUT = new SlotType("cell_out", (t, i, d) -> Optional.of(new SlotOutput(t.itemHandler.map(MachineItemHandler::getOutputHandler).orElse(null), i, d.getX(), d.getY())));
