...
public interface IHaveCover {
    ...
    float INDENTATION_SIDE = 0.25F;
    double INTERACT_DISTANCE = 5;

    default ActionResultType onDrawHighlight(PlayerEntity player, DrawHighlightEvent ev) {
        ...
        if (!(state.getBlock() instanceof BlockMachine) && !(state.getBlock() instanceof BlockPipe)) return ActionResultType.PASS;
