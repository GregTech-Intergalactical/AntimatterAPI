...
public class AntimatterBlockStateProvider extends BlockStateProvider implements IAntimatterProvider {
    ...
    public void state(Block block, ResourceLocation... textures) {
        if (textures.length == 1) {
            ...
            horizontalBlock(block, getSixSidedLayeredModel(block, textures));
        }
    }
    ...
    public BlockModelBuilder getSixSidedSimpleModel(Block block, ResourceLocation... texture) {
        return getSimpleModel(block, texture[0]).texture("down", texture[0]).texture("up", texture[1]).texture("south", texture[2]).texture("north", texture[3]).texture("west", texture[4]).texture("east", texture[5]).texture("particle", texture[1]);
    }

    public BlockModelBuilder getSixSidedLayeredModel(Block block, ResourceLocation... texture) {
        return getLayeredModel(block, texture[0], texture[6]).texture("basedown", texture[0]).texture("baseup", texture[1]).texture("basesouth", texture[2]).texture("basenorth", texture[3]).texture("basewest", texture[4]).texture("baseeast", texture[5]).texture("overlaydown", texture[6]).texture("overlayup", texture[7]).texture("overlaysouth", texture[8]).texture("overlaynorth", texture[9]).texture("overlaywest", texture[10]).texture("overlayeast", texture[11]).texture("particle", texture[1]);
    }
