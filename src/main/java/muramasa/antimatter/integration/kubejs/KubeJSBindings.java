...
public class KubeJSBindings {
    ...
    //                 if (tt.equals(t.getMaterialTag(mat).getName()) && !DynamicResourcePack.hasTag(AntimatterItemTagProvider.getTagLoc("items",tt))) {
    //                     DynamicResourcePack.forceAddTag(AntimatterItemTagProvider.getTagLoc("items",tt), ITag.Builder.create().addItemEntry(it.getRegistryName(), "Antimatter - Dynamic Data").serialize(), true);
    //                 }
    //             });*/
    //             return it;
    //         }
    ...
    //     MaterialType t = AntimatterAPI.get(MaterialType.class, type);
    //     if (t == null) Collections.emptyList();
    //     if (t instanceof MaterialTypeItem) {
